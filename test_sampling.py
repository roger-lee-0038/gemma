...
tokenizer_path = "/home/roger/Downloads/gemma-4-tokenizer/tokenizer_gemma4.model"
...
turn0 = sampler.chat('1+3 equals to ?')
print(turn0)

turn1 = sampler.chat('Write a short poem about lakes', sampling=gm.text.RandomSampling(temperature=0.7))
print(turn1)
