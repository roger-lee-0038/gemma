...
"""Integration test for Gemma EOS embeddings with a real Gemma4 E4B model."""
...
def test_eos_embedding_similarity_for_similar_and_different_prompts():
  ...
  embeddings = gm.text.encode_eos_embeddings(
      prompts,
      model=model,
      params=params,
      tokenizer=tokenizer,
...
if __name__ == "__main__":
  test_eos_embedding_similarity_for_similar_and_different_prompts()
